...
class _NutsState extends State<Nuts> {
              ...
              child: Container(
                child: Row(
                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
                        _buildNutsCard("Paneer Roll", "assets/kiwi.png","₹90", 0xffF7DFB9, 0XffFAF0DA),
                        ...
                        GestureDetector(
                          ...
                          child: _buildNutsCard("Avocado", "assets/avocado.png","₹120", 0xffC4D4A3, 0XffE0E8CF),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildNutsCard("Mango", "assets/mango.png","₹150", 0xffF6E475, 0XffF9EFB0),
                      ],
                    ),
                    Spacer(),
                    Column(
                      children: <Widget>[
                        ...
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildNutsCard("Papaya", "assets/papaya.png","₹45", 0xffFFC498, 0XffFDDCC1),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildNutsCard("Strawberry", "assets/strawberry.png","₹200", 0xffF0AEAF, 0XffF8C6CA),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                      ],
                    )
                  ],
  ...
  _buildNutsCard(String name, String asset, String rate, int color, int color2) {
    return Container(
      width: 42.5 * SizeConfig.widthMultiplier,
      decoration: BoxDecoration(
        color: Color(color),
