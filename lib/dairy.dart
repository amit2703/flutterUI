              ...
              child: Container(
                child: Row(
                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
                        _buildDairyCard("Paneer Roll", "assets/kiwi.png","₹90", 0xffF7DFB9, 0XffFAF0DA),
                        ...
                        GestureDetector(
                          ...
                          child: _buildDairyCard("Avocado", "assets/avocado.png","₹120", 0xffC4D4A3, 0XffE0E8CF),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildDairyCard("Mango", "assets/mango.png","₹150", 0xffF6E475, 0XffF9EFB0),
                      ],
                    ),
                    Spacer(),
                    Column(
                      children: <Widget>[
                        ...
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildDairyCard("Papaya", "assets/papaya.png","₹45", 0xffFFC498, 0XffFDDCC1),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        _buildDairyCard("Strawberry", "assets/strawberry.png","₹200", 0xffF0AEAF, 0XffF8C6CA),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                      ],
                    )
                  ],
